  ...
  policy = <<POLICY
{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": "arn:aws:s3:::terraform-state-bucket-123456"
    },
    { "Action": [
        "s3:GetObject",
        "s3:PutObject",
      ...
      "Effect": "Allow",
      "Resource": "arn:aws:s3:::terraform-state-bucket-123456/terraform.tfstate"
    }
  ]
}
POLICY
...
resource "aws_s3_bucket" "replication_bucket" {
  ...
  bucket_prefix = "${regex("[a-z0-9.-]+", lower(var.project_name))}-replicaiton"
}
...
resource "aws_s3_bucket" "codepipeline_bucket" {
  bucket_prefix = "${regex("[a-z0-9.-]+", lower(var.project_name))}-artifact"
  tags          = var.tags
  force_destroy = true
}
