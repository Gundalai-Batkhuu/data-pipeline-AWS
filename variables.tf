...
variable "lambda_iam_role_name" {
  description = "Name of the IAM role to be used by the Lambda"
  type        = string
  default     = "lambda-role"
}
...
variable "clean_node_names" {
 description = "List of Kedro node names"
 type        = list(string)
 default     = ["test-extract-tables-node", "test-set-column-index-node"]
}

variable "node_names" {
 description = "List of Kedro node names"
 type        = list(string)
 default     = ["extract_tables_node", "set_column_index_node"]
}
