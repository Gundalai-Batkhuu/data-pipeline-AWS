...
In order to get the best out of the framework:
...
* Don't commit any credentials or the local configuration to the repository. Keep all your credentials and local configuration in `conf/local/`
